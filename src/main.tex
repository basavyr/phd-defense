...
\begin{frame}
	...
	\begin{columns}
		\begin{column}{0.45\textwidth}
			\begin{itemize}
				\item $s\equiv sn,c\equiv cn,d\equiv dn$ : \textbf{Jacobi Elliptic Functions} (\textit{Jacobi, 1829})
		...
		\begin{column}{0.55\textwidth}
			\begin{figure}
				\centering
				\includegraphics[scale=0.55]{figures/new-boson/Jacobi-Elliptic-Functions.pdf}
			\end{figure}
		\end{column}
	\end{columns}
\end{frame}
