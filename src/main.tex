	...
	\begin{columns}
		\begin{column}{0.6\textwidth}
			...
			\begin{exampleblock}{Framework}
				\begin{itemize}
					\item \textbf{First semi-classical description} for the $^{163}$Lu, using the Particle-Rotor-Model (\textit{Hamamoto, 2002}.) for an odd-mass nucleus in the $A\approx 160$ region.
				\end{itemize}
			\end{exampleblock}
		\end{column}
		\begin{column}{0.4\textwidth}
...
\begin{frame}
	\frametitle{$\mathbf{W}_0$ Drawbacks}
