...
\begin{frame}
	...
	\begin{alertblock}{Redefinition}
		$TSD1$ and $TSD2$ \textbf{Signature Partner Bands}.
		\begin{align}
			\{TSD1\}&\equiv\left\{\left[0^+,2^+,4^+,\dots\right] \otimes [j^\pi=13/2^+]\right\}\nonumber\\
			\{TSD2\}&\equiv\left\{\left[1^+,3^+,5^+,\dots\right] \otimes [j^\pi=13/2^+]\right\}\nonumber
		\end{align}
	\end{alertblock}
\end{frame}
